...
/**
 * Adding "Special Effects" to points
 */
public class HighlightDecorator implements IVisualEntity {

    private IVisualEntity decoratedEntity;
    ...
    public void draw(Graphics g, int x, int y, String identifier) {
        ...
        // Save original font to restore it later
        Font originalFont = g.getFont();

        // Draw the Laser line from point to corner.
        int cornerX = 30;
        int cornerY = 40;
        Graphics2D g2d = (Graphics2D) g;

        g2d.setColor(new Color(255, 0, 0, 150)); // Red
        ...
        // Draw the Label Background (Yellow)
